...
public class BaseTest {
    ...
    public static Object[][] getLoginData() {
        return new Object[][] {
                { "dulcealergica@yahoo.com", "te$t$tudent" }
        };
    }
    ...
    public void doubleClickPlaylist() {
        WebElement doubleClickPlaylist = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".playlists:nth-child(3)")));
         doubleClickPlaylist.click();
         actions.doubleClick(driver.findElement(By.cssSelector(".playlists:nth-child(3)"))).perform();
    }
